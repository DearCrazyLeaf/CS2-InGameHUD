...
namespace InGameHUD.Managers
{
    public class HUDManager
    {
        ...
        private const byte MAIN_HUD_CHANNEL = 100;
        ...
        {
            if (player == null || !player.IsValid || !playerData.HUDEnabled || player.PlayerPawn?.Value == null)
                return;
        ...
        private Vector GetHUDPosition(HUDPosition position)
        {
            ...
            {
                HUDPosition.TopLeft => new Vector(15, 10, 80),      // 左上角
                HUDPosition.TopRight => new Vector(85, 10, 80),     // 右上角
                HUDPosition.BottomLeft => new Vector(15, 90, 80),   // 左下角
                HUDPosition.BottomRight => new Vector(85, 90, 80),  // 右下角
                HUDPosition.Center => new Vector(50, 50, 80),       // 中间
                _ => new Vector(85, 10, 80)                         // 默认右上角
            };
        }
    }
}